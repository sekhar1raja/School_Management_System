                  ...
                  <form>
                    ...
                    <div className="mb-4">
                      ...
                      <label htmlFor="section" className="form-label d-flex" style={{ color: '#525F7F',fontWeight:'bold' }}>section</label>
                            <input type="text" className="form-control shadow-sm" id="section" name="section" required />
                            <div className="invalid-feedback">
                            section
                            </div>
                        </div>
                        <div className="col-md-12 mb-3 d-flex  row">
                            ...
                            <input type="text" className="form-control shadow-sm" id="Fees" name="Fees" required />
                            <div className="invalid-feedback">
                            Fees
                            </div>
                            </div>
                            ...
                            <label htmlFor="class" className="form-label d-flex" style={{ color: '#525F7F',fontWeight:'bold' }}>class</label>
                          <input type="text" className="form-control shadow-sm" id="class" name="class" required />
                          <div className="invalid-feedback">
                          Class
                          </div>
                            </div>
